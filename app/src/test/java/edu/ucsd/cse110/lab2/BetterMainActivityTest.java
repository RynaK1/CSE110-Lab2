...
public class BetterMainActivityTest {
    ...
    public void test_one_plus_one_equals_two() {
        ...
        scenario.onActivity(activity -> {
            Button btn_one = (Button)activity.findViewById(R.id.btn_one);
            Button btn_plus = (Button)activity.findViewById(R.id.btn_plus);
            Button btn_equals = (Button)activity.findViewById(R.id.btn_equals);
